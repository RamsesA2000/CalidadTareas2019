...
public class crossBrowsing {
	...
	final static String sauceUserName = System.getenv("RamsesMartinez");
    final static String sauceAccessKey = System.getenv("3837196a-4eb7-4704-95f9-f8178ec08fcf");
    final static String sauceURL = "https://RamsesMartinez:3837196a-4eb7-4704-95f9-f8178ec08fcf@ondemand.saucelabs.com:443/wd/hub";
	public static void main(String[] args) throws Exception {
       ...
       WebElement element = driver.findElement(By.xpath("/html/body/div/div/div[2]/button"));
		...
		String name = "Ramses";
		String email = "ramses@prubeaderamses.com";
		String age = "19";
